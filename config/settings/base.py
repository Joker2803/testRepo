...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/study"),
}
...
ADMINS = [("""Abdumalik Ibraximov""", "abdumalik-ibraximov@example.com")]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoiints of Python Learning",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
    "SERVERS": [
        {"url": "https://127.0.0.1:8000", "description": "Local Development server"},
        {"url": "https://qaqnus.com", "description": "Production server"},
    ],
}
# Your stuff...
# ------------------------------------------------------------------------------
